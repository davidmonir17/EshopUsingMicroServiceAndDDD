             ...
             if(entry.State == EntityState.Added)
                {
                    ...
                    entry.Entity.CreatedBy = "DHanna";
                }
             if(entry.State == EntityState.Modified|| entry.State== EntityState.Added|| entry.HasChangedOwendEntities())
                {
                    entry.Entity.LastModified = DateTime.UtcNow;
                    entry.Entity.LastModifiedBy = "DHanna";
                }
            }
